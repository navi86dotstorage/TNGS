...
#    print dp, mq
#ori    if float(b1[5]) >= 50 and float(dp[0]) >= 5 and float(mq[0]) >= 30:
#exist  if float(b1[5]) >= 0 and float(dp[0]) >= 0 and float(mq[0]) >= 0:
    if float(b1[5]) >= 30 and float(dp[0]) >= 5 and float(mq[0]) >= 30:
...
for char in filter1:
    ...
    tmp[5] = dp4[-1]
#ori        if float(dp4[3]) >= 75 and int(dp4[-1]) >5 and int(dp4[6]) >0 and int(dp4[7]) >0:
#exist    if float(dp4[3]) >= 0 and int(dp4[-1]) >0 and int(dp4[6]) >0 and int(dp4[7]) >0:
#new	  if float(dp4[3]) >= 0 and int(dp4[-1]) >0 and int(dp4[6]) >0 and int(dp4[7]) >0:
    if float(dp4[3]) >= 90 and int(dp4[-1]) >= 20 and int(dp4[6]) > 0 and int(dp4[7]) > 0:
...
#ori                elif float(dp4[3]) < 75 and int(dp4[-1]) >5 and int(dp4[4]) >0 and int(dp4[5]) >0 and int(dp4[6]) >0 and int(dp4[7]) >0:
#exist    elif float(dp4[3]) < 0 and int(dp4[-1]) >0 and int(dp4[4]) >0 and int(dp4[5]) >0 and int(dp4[6]) >0 and int(dp4[7]) >0:
#new      elif float(dp4[3]) < 0 and int(dp4[-1]) >0 and int(dp4[4]) >0 and int(dp4[5]) >0 and int(dp4[6]) >0 and int(dp4[7]) >0:
    elif float(dp4[3]) >= 15 and float(dp4[3]) < 90 and int(dp4[-1]) >= 20 and  int(dp4[4]) > 0 and int(dp4[5]) > 0 and int(dp4[6]) > 0 and int(dp4[7]) > 0:
        if tmp[7].startswith("INDEL"):
